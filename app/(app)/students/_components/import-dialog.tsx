...
import { useImportStudentsService } from "../_service/useImportStudentsService";
...
export function ImportStudentsDialog({
  ...
  } = useImportStudentsService(() => onOpenChange(false));
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[520px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload an Excel (.xlsx) or CSV file to bulk-import students. The
            import runs in the background — you will receive an in-app
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="rounded-lg border border-dashed p-4 space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              The template includes all required and optional columns, dropdown
              selectors for <span className="font-medium">Gender</span> and{" "}
              <span className="font-medium">Class Arm</span> (populated with
              your school&apos;s actual class arms), and an Instructions sheet.
          ...
          <div className="flex gap-2 rounded-lg bg-muted/50 p-3">
            ...
            <p className="text-xs text-muted-foreground">
              Duplicate admission numbers will be skipped with an error logged
              per row. Rows with invalid data are skipped — valid rows are still
