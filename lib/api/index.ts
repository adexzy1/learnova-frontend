...
// ==================== STUDENTS ====================
export async function fetchStudents(filters?: TableFilters): Promise<PaginatedResponse<Student>> {
...
// ==================== STAFF ====================
export async function fetchStaff(filters?: TableFilters): Promise<PaginatedResponse<Staff>> {
...
export async function fetchClasses(): Promise<ClassLevel[]> {
  return mockFetch([
    ...
    },
    {
      ...
      order: 3,
      arms: [
        { id: 'class-3a', classLevelId: 'jss3', name: 'A', capacity: 40 },
      ],
    },
    {
      id: 'sss1',
...
// ==================== FINANCE ====================
export async function fetchInvoices(filters?: TableFilters): Promise<PaginatedResponse<Invoice>> {
  const mockInvoices: Invoice[] = [
    ...
    },
    {
      ...
      termId: 'term-1',
      items: [
        { id: 'item-6', description: 'School Fees', amount: 160000 },
      ],
      totalAmount: 160000,
      paidAmount: 0,
      balance: 160000,
...
export async function fetchAttendance(
  ...
  return mockFetch([
    { id: 'att-1', studentId: 'student-1', classId, date, status: 'present', markedBy: 'staff-1', markedAt: date },
    { id: 'att-2', studentId: 'student-2', classId, date, status: 'present', markedBy: 'staff-1', markedAt: date },
    { id: 'att-3', studentId: 'student-3', classId, date, status: 'absent', markedBy: 'staff-1', markedAt: date },
  ])
}

export async function saveAttendance(records: Partial<AttendanceRecord>[]): Promise<AttendanceRecord[]> {
  return mockFetch(records.map((r, i) => ({
    id: `att-${Date.now()}-${i}`,
    ...r,
...
export async function fetchCAScores(
  ...
  return mockFetch([
    { id: 'ca-1', studentId: 'student-1', subjectId, caConfigId: 'ca-test-1', score: 18, termId, enteredBy: 'staff-1', enteredAt: '2024-10-01' },
    { id: 'ca-2', studentId: 'student-2', subjectId, caConfigId: 'ca-test-1', score: 15, termId, enteredBy: 'staff-1', enteredAt: '2024-10-01' },
    { id: 'ca-3', studentId: 'student-1', subjectId, caConfigId: 'ca-test-2', score: 12, termId, enteredBy: 'staff-1', enteredAt: '2024-11-01' },
    { id: 'ca-4', studentId: 'student-2', subjectId, caConfigId: 'ca-test-2', score: 14, termId, enteredBy: 'staff-1', enteredAt: '2024-11-01' },
  ])
}

export async function saveCAScores(scores: Partial<CAScore>[]): Promise<CAScore[]> {
  return mockFetch(scores.map((s, i) => ({
    id: `ca-${Date.now()}-${i}`,
    ...s,
...
export async function fetchExamScores(
  ...
  return mockFetch([
    { id: 'exam-1', studentId: 'student-1', subjectId, termId, score: 65, maxScore: 70, enteredBy: 'staff-1', enteredAt: '2024-12-01', isModerated: false },
    { id: 'exam-2', studentId: 'student-2', subjectId, termId, score: 58, maxScore: 70, enteredBy: 'staff-1', enteredAt: '2024-12-01', isModerated: false },
  ])
}
...
// ==================== ADMISSIONS ====================
export async function fetchAdmissions(filters?: TableFilters): Promise<PaginatedResponse<AdmissionApplication>> {
  const mockAdmissions: AdmissionApplication[] = [
    {
      ...
      documents: [
        { id: 'doc-1', name: 'Birth Certificate', type: 'pdf', url: '/docs/bc.pdf', uploadedAt: '2024-08-01' },
      ],
  ...
  return mockFetch([
    {
      ...
      reportedBy: 'staff-1',
      sanctions: [
        { id: 'sanc-1', type: 'warning', description: 'Verbal warning issued', startDate: '2024-10-15', issuedBy: 'staff-1' },
      ],
      status: 'resolved',
    },
  ])
  ...
  return mockFetch([
    {
      ...
      content: 'I would like to schedule a meeting to discuss your child\'s progress.',
      status: 'read',
...
export async function fetchDashboardStats(): Promise<DashboardStats> {
  return mockFetch({
    ...
    upcomingExams: 5,
    recentActivities: [
      { id: '1', type: 'admission', description: 'New student application received', timestamp: '2024-12-15T10:30:00Z' },
      { id: '2', type: 'payment', description: 'Payment of ₦150,000 received from John Doe', timestamp: '2024-12-15T09:15:00Z' },
      { id: '3', type: 'attendance', description: 'Attendance marked for JSS 1A', timestamp: '2024-12-15T08:00:00Z' },
    ],
  })
}
...
export async function fetchFeeTypes(): Promise<FeeType[]> {
  return mockFetch([
    { id: 'fee-1', name: 'School Fees', description: 'Tuition and general fees', amount: 150000, applicableTo: 'all', isActive: true },
    { id: 'fee-2', name: 'Examination Fee', description: 'Terminal examination fee', amount: 25000, applicableTo: 'all', isActive: true },
    { id: 'fee-3', name: 'Sports Fee', description: 'Annual sports activities', amount: 10000, applicableTo: 'all', isActive: true },
    { id: 'fee-4', name: 'Laboratory Fee', description: 'Science laboratory usage', amount: 15000, applicableTo: 'SSS', isActive: true },
    { id: 'fee-5', name: 'Library Fee', description: 'Library maintenance', amount: 5000, applicableTo: 'all', isActive: true },
  ])
}
